...
export const EXPERIENCE: Experience[] = [
  {
    ...
    detail_en:
      "Part of the core dev team building Powerhouse — a DAO operations platform covering governance, document management, and budgeting — with ~2,100 commits of my own in the monorepo. Ship features on Renown (wallet-based identity + credential SDK: DID:pkh, EVM signatures, JWT bearer sessions) and contribute to the design system used across Connect, Academy, and Vetra. The platform also ships Reactor MCP, an MCP server agents connect to for scaffolding document models, editors, drives, and documents end-to-end. Stack: React, TypeScript, Electron, GraphQL, Node.js, Express, Redux, TailwindCSS, Vite, Storybook, Vitest.",
    detail_es:
      "Parte del core dev team que construye Powerhouse — plataforma de operaciones para DAOs que cubre gobernanza, gestión documental y presupuestos — con ~2.100 commits propios en el monorepo. Envío features sobre Renown (SDK de identidad y credenciales basado en wallet: DID:pkh, firmas EVM, sesiones JWT bearer) y contribuyo al design system usado en Connect, Academy y Vetra. La plataforma también incluye Reactor MCP, un servidor MCP al que los agentes se conectan para scaffolding de document models, editors, drives y documentos de punta a punta. Stack: React, TypeScript, Electron, GraphQL, Node.js, Express, Redux, TailwindCSS, Vite, Storybook, Vitest.",
  },
  {
    role_en: "Senior Software Engineer",
    role_es: "Senior Software Engineer",
