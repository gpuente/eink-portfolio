...
export const COPY: Record<Lang, Copy> = {
  en: {
    ...
    heroB: ".",
    tagline:
      "Senior full-stack engineer with 10+ years shipping products at MakerDAO SES, Evernote, Fleek, Groupon, and ComparaOnline — focused on AI integration (LLMs, RAG, agents) and on an agent-driven workflow that accelerates delivery across complex codebases.",
  ...
  es: {
    ...
    heroB: ".",
    tagline:
      "Ingeniero full-stack senior con más de 10 años enviando productos en MakerDAO SES, Evernote, Fleek, Groupon y ComparaOnline — enfocado en integración de IA (LLMs, RAG, agents) y en un flujo de desarrollo basado en agentes que acelera la entrega en codebases complejas.",
    ...
    chat: {
      ...
      helpTitle: "Puedes preguntar por:",
      helpItems: [
        "Trayectoria, experiencia y proyectos",
        "Trabajo en IA — LLMs, RAG y agents",
        "Disponibilidad para una reunión y agendar un slot",
        "Actividad reciente en GitHub y repos destacados",
      ],
      emptyHint: "Pregúntame sobre el trabajo, la disponibilidad o la actividad en GitHub de Guillermo.",
      starterChips: [
        "¿En qué proyectos de IA ha trabajado?",
        "¿Cuándo tiene disponibilidad para una llamada de 30 min?",
        "¿En qué ha estado trabajando en GitHub últimamente?",
      ],
      thinking: "Pensando…",
